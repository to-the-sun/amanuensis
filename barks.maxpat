...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 463.300000000000011, 320.0, 60.0, 20.0 ],
					"text" : "s transients"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 120.0, 190.0, 151.0, 41.0 ],
									"text" : " probably no need to divide by number audible, so disabled for now"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 320.0, 220.0, 56.0, 20.0 ],
									"sig" : 0.0
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "float" ],
									"patching_rect" : [ 313.666666666666742, 160.0, 56.0, 20.0 ],
									"sig" : 0.0
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"text" : "* 2 because round~ will transition between integers halfway along the ramp"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 110.0, 140.0, 29.5, 20.0 ],
													"text" : "* 2"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 110.0, 120.0, 50.0, 20.0 ],
													"text" : "r A_wake"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "signal" ],
													"patching_rect" : [ 50.0, 190.0, 109.0, 20.0 ],
													"text" : "rampsmooth~ 0 99999"
												}
...
,
									"patching_rect" : [ 213.666666666666742, 130.0, 60.0, 20.0 ],
...
,
									"patching_rect" : [ 95.333333333333258, 130.0, 60.0, 20.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"fontsize" : 10.0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 162.666666666666742, 150.0, 100.0, 20.0 ],
									"text" : "/~ 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 162.666666666666742, 130.0, 49.0, 20.0 ],
									"text" : "mc.sum~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 162.666666666666742, 100.0, 126.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 50.0, 80.0, 225.0, 20.0 ],
									"text" : "mc.receive~ jamming 16 @busymapname tracks"
								}
...
,
					"patching_rect" : [ 478.0, 260.0, 69.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 463.300000000000011, 300.0, 37.0, 20.0 ],
					"text" : "edge~"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 701.0, 530.0, 31.0, 20.0 ],
									"text" : "out 8"
								}
...
, 							{
								"box" : 								{
									"code" : "Buffer tolerance(\"tolerance\");\r\nBuffer wake(\"wake\");\r\nBuffer windows(\"windows\");\r\nBuffer rhythm1(\"rhythm1\");\r\nHistory peak(0);\r\nHistory jamming_peak(0);\r\nHistory recitation_peak(0);\r\nHistory jamming_score(0);\r\nHistory recitation_score(0);\r\nHistory step(0);\r\nHistory prior_peak(0);\r\nHistory prior_jamming(0);\r\nHistory prior_recitation(0);\r\nHistory groove_window(0);\r\nHistory numerous(0);\r\nHistory largest(.000001);\r\nDelay momentarily_jamming(99999);\r\nDelay momentarily_recitation(99999);\r\nTOLERANCE = 20;\r\ntolerance_samples = mstosamps(TOLERANCE);\r\nWAKE = 8000;\r\nwake_samples = mstosamps(WAKE);\r\natom = TOLERANCE * 2;\r\natom_samples = mstosamps(atom);\r\njamming_transients = slide(abs(in2), 0, wake_samples);\r\njamming_beats = sah(jamming_transients, delta(jamming_transients) < 0, .5);\r\nwrite(momentarily_jamming, jamming_beats);\r\nrecitation_transients = slide(abs(in3), 0, wake_samples * 9);\r\nrecitation_beats = sah(recitation_transients, delta(recitation_transients) < 0, .5);\r\nwrite(momentarily_recitation, recitation_beats);\r\nout1 = delta(jamming_transients) > 0;\r\nout2 = step;\r\nout5 = 0;\r\nout6 = jamming_transients;\r\nout7 = recitation_transients;\r\nout3 = delta(jamming_beats * (jamming_beats != read(momentarily_jamming, tolerance_samples))) > 0;\r\nout4 = recitation_beats * (recitation_beats != read(momentarily_recitation, tolerance_samples));\r\nout8 = numerous;",
									"fontface" : 0,
									"fontname" : "<Monospaced>",
									"fontsize" : 10.0,
									"id" : "obj-3",
...
,
					"patching_rect" : [ 463.300000000000011, 280.0, 92.5, 20.0 ],
					"text" : "gen~"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 130.0, 292.5, 49.0, 20.0 ],
									"text" : "tosymbol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 130.0, 312.5, 93.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 140.0, 32.5, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 140.0, 62.5, 53.0, 20.0 ],
									"text" : "Uzi 11000"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 70.0, 62.5, 50.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 70.0, 92.5, 93.0, 20.0 ],
									"text" : "Prepend transcribe"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 42.5, 246.0, 20.0 ],
									"text" : "transcribe \" claw1 234-7810 other things other things\""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 275.0, 232.5, 50.0, 20.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 130.0, 262.5, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 290.0, 302.5, 46.0, 20.0 ],
									"text" : "deferlow"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 290.0, 322.5, 75.0, 20.0 ],
									"text" : "transcribe 1 #1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 352.0, 441.5, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 270.0, 352.5, 31.0, 20.0 ],
									"text" : "bang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 280.0, 431.5, 33.0, 20.0 ],
									"text" : "zl reg"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 292.0, 411.5, 119.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 292.0, 391.5, 47.0, 20.0 ],
									"text" : "zl slice 2"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 392.0, 601.5, 94.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 244.0, 481.5, 55.0, 20.0 ],
									"text" : "script start"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 244.0, 461.5, 30.0, 20.0 ],
									"text" : "sel 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 244.0, 372.5, 67.0, 20.0 ],
									"text" : "route running"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 110.0, 172.5, 129.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 95.0, 152.5, 185.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 580.0, 521.5, 18.0, 146.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 515.0, 466.0, 51.0, 20.0 ],
									"text" : "print shall"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 515.0, 446.0, 139.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 515.0, 426.0, 111.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 110.0, 192.5, 46.0, 20.0 ],
									"text" : "deferlow"
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 440.0, 2.5, 400.0, 220.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 510.0, 551.5, 71.0, 20.0 ],
									"text" : "print output"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 110.0, 371.5, 27.0, 20.0 ],
									"text" : "iter"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 275.0, 272.5, 55.0, 20.0 ],
									"text" : "script start"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 110.0, 352.5, 124.0, 20.0 ],
									"saved_object_attributes" : 									{
										"autostart" : 0,
										"defer" : 0,
										"node_bin_path" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 160.0, 250.0, 150.0, 41.0 ],
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-57", 0 ],
									"midpoints" : [ 284.5, 339.0, 119.5, 339.0 ],
									"order" : 2,
									"source" : [ "obj-12", 0 ]
								}
...
,
					"patching_rect" : [ 171.0, 330.0, 53.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 570.0, 20.0, 161.0, 20.0 ],
					"restore" : [ 0.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
...
,
					"text" : "pattr barks_freq @autorestore 0",
					"varname" : "barks_freq"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 640.0, 40.0, 50.0, 20.0 ],
					"varname" : "number"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 640.0, 60.0, 90.0, 20.0 ],
					"text" : "s barks_frequency"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 171.0, 310.0, 59.0, 20.0 ],
					"text" : "r to_python"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 540.0, 70.0, 59.0, 20.0 ],
					"text" : "r transcribe"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 542.0, 50.0, 60.0, 20.0 ],
					"text" : "s transcribe"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 542.0, 20.0, 24.0, 24.0 ],
					"varname" : "toggle"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 478.0, 0.0, 158.0, 20.0 ],
					"restore" : [ 0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
,
					"text" : "pattr transcribe @autorestore 0",
					"varname" : "transcribe"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 140.0, 80.0, 84.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 250.0, 150.0, 51.0, 20.0 ],
					"text" : "zl change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 250.0, 80.0, 50.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 250.0, 100.0, 58.0, 20.0 ],
					"text" : "v eq_mode"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 250.0, 130.0, 45.0, 20.0 ],
					"text" : "gate 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 250.0, 170.0, 62.0, 20.0 ],
					"text" : "speedlim 40"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 190.0, 170.0, 60.0, 20.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 190.0, 190.0, 79.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 190.0, 230.0, 38.0, 20.0 ],
					"text" : "s OSC"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 190.0, 210.0, 119.0, 20.0 ],
					"text" : "prepend /amanuensis/eq"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 210.0, 152.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "int", "int" ],
									"patching_rect" : [ 151.0, 220.0, 52.0, 20.0 ],
									"text" : "change 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 151.0, 200.0, 78.0, 20.0 ],
									"text" : "r eq_normalizer"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 231.0, 260.0, 80.0, 20.0 ],
									"text" : "s eq_normalizer"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 431.0, 260.0, 121.0, 20.0 ],
									"text" : "print \"Peak EQ Jamming\""
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 231.0, 240.0, 45.0, 20.0 ],
									"text" : "peak -9."
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 231.0, 200.0, 66.0, 20.0 ],
									"text" : "maximum -9."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 250.0, 180.0, 20.0 ],
									"text" : "vexpr ($f1 / $f2) * 1.75 @scalarmode 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "int" ],
									"patching_rect" : [ 63.5, 130.0, 66.0, 20.0 ],
									"text" : "maximum -9."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 207.0, 130.0, 55.0, 20.0 ],
									"text" : "peakamp~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 160.0, 175.0, 20.0 ],
...
,
					"patching_rect" : [ 140.0, 100.0, 107.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 10.0,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 325.0, 170.0, 75.0, 20.0 ],
									"text" : "r ---conscious?"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 325.0, 190.0, 30.0, 20.0 ],
									"text" : "sel 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "bang" ],
									"patching_rect" : [ 325.0, 210.0, 61.0, 20.0 ],
									"text" : "t bang bang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 305.0, 300.0, 41.0, 20.0 ],
									"text" : "zl iter 1"
								}
...
,
									"patching_rect" : [ 305.0, 280.0, 75.0, 20.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"fontsize" : 10.0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 263.0, 280.0, 40.0, 20.0 ],
									"text" : "unjoin"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 200.0, 340.0, 29.5, 20.0 ],
									"text" : "t i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 200.0, 210.0, 114.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 200.0, 250.0, 82.0, 20.0 ],
									"text" : "route 1 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 200.0, 230.0, 42.0, 20.0 ],
									"text" : "zl rot -1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 305.0, 370.0, 29.5, 20.0 ],
									"text" : "* 20"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 200.0, 440.0, 57.0, 20.0 ],
									"save" : [ "#N", "thispatcher", ";", "#Q", "end", ";" ],
									"text" : "thispatcher"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 200.0, 420.0, 194.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 200.0, 400.0, 40.0, 20.0 ],
									"text" : "join 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 215.0, 370.0, 90.0, 20.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 350.0, 210.0, 75.0, 20.0 ],
									"text" : "r ---conscious?"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 350.0, 230.0, 30.0, 20.0 ],
									"text" : "sel 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "bang" ],
									"patching_rect" : [ 350.0, 250.0, 61.0, 20.0 ],
									"text" : "t bang bang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 350.0, 290.0, 41.0, 20.0 ],
									"text" : "zl iter 1"
								}
...
,
									"patching_rect" : [ 350.0, 270.0, 75.0, 20.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"fontsize" : 10.0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 303.0, 280.0, 40.0, 20.0 ],
									"text" : "unjoin"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 240.0, 210.0, 114.0, 20.0 ],
									"text" : "r ---midi_audio_channel"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 240.0, 250.0, 82.0, 20.0 ],
									"text" : "route 1 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 240.0, 230.0, 42.0, 20.0 ],
									"text" : "zl rot -1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 250.0, 320.0, 29.5, 20.0 ],
									"text" : "t i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 646.0, 10.0, 74.0, 20.0 ],
									"text" : "r ---track_input"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 646.0, 50.0, 82.0, 20.0 ],
									"text" : "route 1 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 646.0, 30.0, 42.0, 20.0 ],
									"text" : "zl rot -1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 460.0, 340.0, 57.0, 20.0 ],
									"save" : [ "#N", "thispatcher", ";", "#Q", "end", ";" ],
									"text" : "thispatcher"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 460.0, 320.0, 139.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "bang", "bang", "int" ],
									"patching_rect" : [ 428.0, 290.0, 51.0, 20.0 ],
									"text" : "Uzi 17 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 428.0, 270.0, 50.0, 20.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 355.0, 350.0, 29.5, 20.0 ],
									"text" : "* 20"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 250.0, 420.0, 57.0, 20.0 ],
									"save" : [ "#N", "thispatcher", ";", "#Q", "end", ";" ],
									"text" : "thispatcher"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 250.0, 400.0, 191.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 250.0, 380.0, 40.0, 20.0 ],
									"text" : "join 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 265.0, 350.0, 82.0, 20.0 ],
