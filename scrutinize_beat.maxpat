...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 75.0, 260.0, 33.0, 20.0 ],
					"style" : "",
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 75.0, 230.0, 80.0, 20.0 ],
					"style" : "",
					"text" : "zl 32727 group"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 192.5, 100.0, 29.5, 20.0 ],
					"style" : "",
					"text" : "!/ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 119.0, 170.0, 29.5, 20.0 ],
					"style" : "",
					"text" : "+ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 100.5, 100.0, 52.0, 20.0 ],
					"style" : "",
					"text" : "zl ecils 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 100.5, 80.0, 63.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 100.5, 60.0, 88.0, 20.0 ],
					"style" : "",
					"text" : "prepend symbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 192.5, 60.0, 65.0, 20.0 ],
					"style" : "",
					"text" : "peek~ stats"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 100.5, 40.0, 31.0, 20.0 ],
					"style" : "",
					"text" : "t s 6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 90.0, 20.0, 40.0, 20.0 ],
					"style" : "",
					"text" : "unjoin"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.0, 0.0, 93.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 203.0, 80.0, 54.0, 20.0 ],
					"style" : "",
					"text" : "r A_wake"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 75.0, 200.0, 53.0, 20.0 ],
					"style" : "",
					"text" : "split 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 42.0, 180.0, 52.0, 20.0 ],
					"style" : "",
					"text" : "zl ecils 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 0.0, 160.0, 61.0, 20.0 ],
					"style" : "",
					"text" : "filter_cues"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 0.0, 120.0, 38.0, 20.0 ],
					"style" : "",
					"text" : "dump"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 0.0, 140.0, 63.0, 20.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
,
