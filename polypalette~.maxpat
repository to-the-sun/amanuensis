...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 130.0, 400.0, 152.0, 74.0 ],
					"text" : "This must happen for all voices, so handled directly, whereas in 2 should preferably only start using up palette space when the first note comes in on that voice"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 46.0, 400.0, 85.0, 20.0 ],
					"text" : "r A_phasorLock"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 57.0, 160.0, 62.0, 20.0 ],
					"text" : "s #0start"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 57.0, 130.0, 40.0, 20.0 ],
					"text" : "t 0. 1 i"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 34.0, 320.0, 150.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 290.0, 80.0, 20.0 ],
					"text" : "prepend offset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 60.0, 270.0, 29.5, 20.0 ],
					"text" : "- 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 34.666687000000003, 250.0, 57.0, 20.0 ],
					"text" : "dspstate~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 57.0, 90.0, 92.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 57.0, 110.0, 55.0, 20.0 ],
					"text" : "thispoly~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 117.0, 160.0, 67.0, 20.0 ],
					"text" : "s #0voice"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 107.0, 180.0, 60.0, 31.0 ],
					"text" : "sprintf set palette.%i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 526.75, 70.0, 189.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 625.25, 420.0, 59.0, 53.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 16.0, 400.0, 28.0, 20.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
,
									"patching_rect" : [ 311.0, 310.0, 104.0, 20.0 ],
									"saved_object_attributes" : 									{
										"accentcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
										"description" : "",
										"digest" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 20.75, 20.0, 189.5, 85.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 0.75, 220.0, 89.25, 85.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 503.5, 380.0, 128.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 105.0, 220.0, 115.666656000000003, 20.0 ],
									"text" : "t i 0"
								}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 0.0, 226.0, 170.0, 230.0 ],
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 255.5, 420.0, 117.0, 40.0 ],
...
,
									"patching_rect" : [ 74.0, 350.0, 83.0, 20.0 ],
									"saved_object_attributes" : 									{
										"accentcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
										"description" : "",
										"digest" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 74.0, 390.0, 256.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 137.583327999999995, 310.0, 50.5, 20.0 ],
									"text" : "unjoin 3"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 346.5, 20.0, 281.0, 40.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 416.0, 280.0, 158.0, 31.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 186.5, 110.0, 47.0, 31.0 ],
									"text" : "r #0start "
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 436.0, 310.0, 138.0, 31.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 468.0, 410.0, 144.0, 20.0 ],
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-39", 0 ],
									"midpoints" : [ 91.0, 284.5, 211.166655999999989, 284.5 ],
									"source" : [ "obj-23", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-39", 0 ],
									"midpoints" : [ 142.166666666666686, 284.5, 211.166655999999989, 284.5 ],
									"source" : [ "obj-42", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-47", 0 ],
									"midpoints" : [ 211.166655999999989, 344.5, 83.5, 344.5 ],
									"source" : [ "obj-51", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-45", 1 ],
									"midpoints" : [ 168.083327999999995, 384.5, 113.125, 384.5 ],
									"source" : [ "obj-7", 2 ]
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 239.666672000000005, 20.0, 100.5, 51.0 ],
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 104.333336000000003, 150.0, 59.0, 20.0 ],
																	"text" : "pack i | f ~/"
																}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 374.583344000000011, 230.0, 91.0, 20.0 ],
					"text" : "v palettePosition"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 310.0, 490.0, 150.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 250.0, 130.0, 61.0, 20.0 ],
					"text" : "r #0start",
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-36", 0 ],
					"midpoints" : [ 69.5, 314.5, 188.75, 314.5 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-28", 0 ],
					"midpoints" : [ 87.5, 154.5, 116.5, 154.5 ],
					"order" : 3,
					"source" : [ "obj-55", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 87.5, 154.5, 126.5, 154.5 ],
					"order" : 2,
					"source" : [ "obj-55", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 87.5, 154.5, 192.5, 154.5 ],
					"order" : 1,
					"source" : [ "obj-55", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 87.5, 154.0, 296.888895666666713, 154.0 ],
					"order" : 0,
					"source" : [ "obj-55", 2 ]
				}
