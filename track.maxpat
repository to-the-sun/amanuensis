...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1091.0, 100.0, 29.5, 20.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1091.0, 70.0, 45.0, 20.0 ],
					"text" : "== 1024"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 117.5, 110.0, 29.5, 20.0 ],
									"text" : "- 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 170.0, 170.0, 62.0, 20.0 ],
									"text" : "Prepend set"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 170.0, 150.0, 74.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 117.5, 130.0, 54.0, 20.0 ],
									"text" : "append 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 117.5, 150.0, 42.0, 20.0 ],
									"text" : "adc~ 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 81.5, 170.0, 58.0, 20.0 ],
									"text" : "selector~ 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 23.5, 80.0, 77.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 81.5, 200.0, 69.0, 20.0 ],
									"text" : "send~ audio_"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 99.5, 80.0, 96.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 23.5, 50.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 550.5, 520.0, 81.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 520.0, 360.0, 104.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 520.0, 340.0, 29.5, 20.0 ],
					"text" : "== 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 480.0, 340.0, 40.0, 20.0 ],
					"text" : "Split 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 480.0, 310.0, 34.0, 20.0 ],
					"text" : ">= #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1100.0, 250.0, 29.5, 20.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1080.0, 220.0, 39.0, 32.0 ],
					"varname" : "gswitch2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1080.0, 200.0, 29.5, 20.0 ],
					"text" : "<= 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1080.0, 180.0, 69.0, 20.0 ],
					"text" : "loadmess #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1151.0, 180.0, 29.5, 20.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1090.0, 160.0, 80.0, 20.0 ],
					"text" : "Substitute #1 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1090.0, 140.0, 29.5, 20.0 ],
					"text" : "- 48"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 1090.0, 120.0, 58.0, 20.0 ],
					"text" : "Split 49 52"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1070.0, 50.0, 50.5, 20.0 ],
					"text" : "key"
				}
...
, 			{
				"box" : 				{
					...
					"border" : 2,
					"bordercolor" : [ 0.0, 0.0, 0.0, 0.227889629251623 ],
					"hidden" : 1,
					"id" : "obj-59",
					"maxclass" : "panel",
					"mode" : 0,
...
, 			{
				"box" : 				{
					...
					"hidden" : 1,
					"id" : "obj-30",
					"linecolor" : [ 0.0, 0.0, 0.0, 0.227889629251623 ],
					"maxclass" : "live.line",
					"numinlets" : 1,
					"numoutlets" : 0,
