...
, 							{
								"box" : 								{
									...
									"id" : "obj-26",
									"items" : [ "Bome MIDI Translator 1", ",", "2- Focusrite USB MIDI", ",", "KeyRig 49", ",", "mouse", ",", "Logitech Dual Action", ",", "OpenFace", ",", "computer keyboard" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
