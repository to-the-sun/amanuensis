...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 14.0, 200.0, 151.0, 29.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 110.0, 230.0, 30.0, 20.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 60.0, 300.0, 29.5, 20.0 ],
					"text" : "* -1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 60.0, 320.0, 42.0, 20.0 ],
					"text" : "t bang f"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 14.0, 280.0, 65.0, 20.0 ],
					"text" : "sampstoms~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 14.0, 260.0, 55.0, 20.0 ],
					"text" : "snapshot~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 14.0, 230.0, 90.0, 20.0 ],
					"text" : "receive~ ---phasor"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 280.0, 140.0, 150.0, 29.0 ],
					"text" : " change because triggering again when program closes?"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 260.0, 380.0, 82.0, 20.0 ],
					"text" : "join"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 260.0, 310.0, 82.0, 20.0 ],
					"text" : "t bang bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 323.0, 350.0, 55.0, 20.0 ],
					"text" : "snapshot~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 260.0, 350.0, 61.0, 20.0 ],
					"text" : "Counter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 487.0, 460.0, 124.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 360.0, 230.0, 61.0, 20.0 ],
					"text" : "t 0 bang"
				}
