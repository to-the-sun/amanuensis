...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 187.5, 150.0, 44.0, 20.0 ],
					"text" : "pak [ s ]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 170.0, 190.0, 146.0, 20.0 ],
					"text" : "\"p txt_backwards-compatibility\""
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									"annotation" : "",
									"comment" : "set message box, right inlet",
									"id" : "obj-6",
									"index" : 2,
									"maxclass" : "outlet",
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 134.0, 274.864516999999978, 30.0, 30.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 275.0, 392.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									"annotation" : "",
									"comment" : "set live.text, left inlet",
									"id" : "obj-5",
									"index" : 1,
									"maxclass" : "outlet",
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 80.0, 274.864516999999978, 30.0, 30.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 185.0, 391.458069000000023, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 80.0, 135.135482999999994, 22.0, 20.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 185.0, 217.135482999999994, 22.0, 20.0 ],
									"text" : "t b"
								}
...
, 							{
								"box" : 								{
									"comment" : "bang through a deferlow",
									"id" : "obj-2",
									"index" : 1,
									"maxclass" : "inlet",
									"numinlets" : 0,
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 80.0, 90.0, 30.0, 30.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 185.0, 172.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 195.0, 332.0, 66.0, 20.0 ],
									"text" : "prepend text"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 80.0, 170.0, 103.0, 20.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 185.0, 252.0, 103.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 185.0, 286.864516999999978, 84.0, 20.0 ],
...
,
					"patching_rect" : [ 170.0, 130.0, 87.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 300.0, 50.0, 52.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 170.0, 10.0, 24.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 190.0, 50.0, 102.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 37.0, 130.0, 42.0, 20.0 ],
					"text" : "s ---log"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 10.0, 110.0, 46.5, 20.0 ],
					"text" : "t l l"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patching_rect" : [ 149.933334000000002, 114.5, 65.0, 20.0 ],
									"text" : "sampstoms~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 138.0, 44.0, 52.0, 20.0 ],
									"text" : "receive~ t"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 104.333336000000003, 150.0, 54.0, 20.0 ],
									"text" : "pack f | f t|"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 50.0, 115.0, 47.0, 20.0 ],
									"text" : "cpuclock"
								}
...
,
					"patching_rect" : [ 10.0, 90.0, 122.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 10.0,
