...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 0.0, 460.0, 130.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 0.0, 440.0, 29.5, 20.0 ],
					"text" : "join"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 0.0, 420.0, 55.0, 20.0 ],
					"text" : "thispoly~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 0.0, 400.0, 45.0, 20.0 ],
					"text" : "t bang f"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 121.0, 240.0, 50.0, 20.0 ],
									"text" : "append 0"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 100.0, 220.0, 40.0, 20.0 ],
									"text" : "Uzi 1 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 100.0, 200.0, 43.0, 20.0 ],
									"text" : "v tracks"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 100.0, 270.0, 130.0, 20.0 ],
									"saved_object_attributes" : 									{
										"embed" : 0,
										"precision" : 6
									}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 100.0, 180.0, 61.0, 20.0 ],
									"text" : "t bang clear"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 100.0, 130.0, 75.0, 20.0 ],
									"text" : "r ---conscious?"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 30.0, 120.0, 54.0, 20.0 ],
									"text" : "metro 100"
								}
...
,
					"patching_rect" : [ 0.0, 330.0, 90.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 0.0, 215.0, 52.0 ],
					"text" : " the signal input portion of this is possibly the only thing that would need to be saved from organism.maxpat when implementing a modular Restless Virtuoso",
					"textcolor" : [ 0.890196078431372, 0.52156862745098, 0.52156862745098, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 0.0, 180.0, 48.0, 20.0 ],
					"text" : "> 0.0009"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 294.75, 320.0, 79.0, 20.0 ],
					"text" : "Print polyinput"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 0.0, 160.0, 72.0, 20.0 ],
					"text" : "peakamp~ 99"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 13.5, 70.0, 55.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "int", "int" ],
					"patching_rect" : [ 13.5, 90.0, 55.0, 20.0 ],
					"text" : "thispoly~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 13.5, 110.0, 80.0, 20.0 ],
					"text" : "Prepend select"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 0.0, 140.0, 68.0, 20.0 ],
					"text" : "mc.resize~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 0.0, 50.0, 124.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 260.0, 110.0, 29.5, 20.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 118.0, 420.0, 65.0, 20.0 ],
					"text" : "s do_export"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 272.25, 134.0, 124.0, 52.0 ],
					"text" : " buddy system ensures track_input is sent first, necessary for palette gates"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 113.875, 140.0, 38.0, 20.0 ],
					"text" : "buddy"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 290.0, 42.0, 104.666664123535156, 87.0 ],
					"text" : " listens for commands to flush this channel specifically or all channels (-1). -9 also immediately kills input"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 70.0, 440.0, 83.0, 20.0 ],
					"text" : "s ---track_input"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 113.875, 190.0, 34.0, 20.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 194.875, 130.0, 55.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "int", "int" ],
					"patching_rect" : [ 194.875, 150.0, 55.0, 20.0 ],
					"text" : "thispoly~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 113.875, 170.0, 100.0, 20.0 ],
					"text" : "join 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 194.0, 40.0, 55.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "int", "int" ],
					"patching_rect" : [ 194.0, 60.0, 55.0, 20.0 ],
					"text" : "thispoly~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 183.5, 20.0, 94.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 183.5, 80.0, 51.0, 20.0 ],
					"text" : "sel i -1 -9"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 198.25, 380.0, 79.0, 20.0 ],
					"text" : "s midiChannel"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 131.0, 360.0, 86.25, 20.0 ],
					"text" : "t i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 294.75, 410.0, 29.5, 20.0 ],
					"text" : "join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "int", "int" ],
					"patching_rect" : [ 294.75, 390.0, 55.0, 20.0 ],
					"text" : "thispoly~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 294.75, 370.0, 46.0, 20.0 ],
					"text" : "t bang i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 294.75, 429.0, 134.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 214.0, 190.0, 72.0, 20.0 ],
					"text" : "r ---tolerance"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 214.0, 210.0, 29.5, 20.0 ],
					"text" : "* 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 162.0, 210.0, 54.0, 20.0 ],
					"text" : "r A_wake"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 162.0, 250.0, 54.0, 20.0 ],
					"text" : "r A_wake"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 131.0, 400.0, 93.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 131.0, 380.0, 70.0, 20.0 ],
					"text" : "prepend -1 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 121.0, 210.0, 40.0, 20.0 ],
					"text" : "split 0."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 110.0, 110.0, 110.5, 20.0 ],
					"text" : "borax"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 131.0, 320.0, 34.0, 20.0 ],
					"text" : "bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 70.0, 420.0, 29.5, 20.0 ],
					"text" : "join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "int", "int" ],
					"patching_rect" : [ 70.0, 400.0, 55.0, 20.0 ],
					"text" : "thispoly~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 294.75, 279.0, 131.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 294.75, 300.0, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 110.0, 90.0, 28.0, 20.0 ],
					"text" : "in 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "int", "int" ],
					"patching_rect" : [ 131.0, 340.0, 55.0, 20.0 ],
					"text" : "thispoly~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 162.0, 230.0, 67.0, 20.0 ],
					"text" : "pak 8000 18"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 70.0, 240.0, 54.0, 20.0 ],
					"text" : "t 0 1 stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 105.0, 270.0, 56.0, 20.0 ],
					"text" : "pipe 8000"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 87.0, 330.0, 34.0, 20.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 151.5, 234.5, 79.5, 234.5 ],
					"source" : [ "obj-20", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 130.5, 263.5, 114.5, 263.5 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 97.0, 293.5, 114.5, 293.5 ],
					"source" : [ "obj-23", 1 ]
				}
