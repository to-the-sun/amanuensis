...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 102.0, 90.0, 61.0, 20.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 20.0, 160.0, 69.0, 20.0 ],
					"text" : "send~ audio1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 102.0, 150.0, 69.0, 20.0 ],
					"text" : "send~ audio1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 81.0, 110.0, 40.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 20.0, 60.0, 80.0, 20.0 ],
					"text" : "t bang s bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 51.0, 90.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numpoints" : 441,
					"outlettype" : [ "" ],
					"patching_rect" : [ 430.0, 140.0, 100.0, 50.0 ],
					"subplots" : [ 						{
...
, 			{
				"box" : 				{
					...
					"numpoints" : 441,
					"outlettype" : [ "" ],
					"patching_rect" : [ 440.0, 90.0, 100.0, 50.0 ],
					"subplots" : [ 						{
							"color" : [ 0.3125, 1.0, 0.838867, 1.0 ],
							"thickness" : 1.200000047683716,
							"point_style" : "none",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 330.0, 170.0, 56.0, 20.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 104.0, 290.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 130.0, 360.0, 47.0, 20.0 ],
					"text" : "play~ o2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 510.0, 230.0, 30.0, 20.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 179.0, 390.0, 30.0, 20.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 230.0, 360.0, 256.0, 64.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "float", "float", "float", "float", "list", "" ],
					"patching_rect" : [ 230.0, 300.0, 256.0, 64.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "float", "float", "float", "float", "list", "" ],
					"patching_rect" : [ 230.0, 240.0, 256.0, 64.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 500.0, 330.0, 79.0, 20.0 ],
					"text" : "buffer~ o2 3999"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 500.0, 300.0, 79.0, 20.0 ],
					"text" : "buffer~ o1 3999"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 500.0, 270.0, 89.0, 20.0 ],
					"text" : "buffer~ input 3999"
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 170.0, 230.0, 30.0, 20.0 ],
									"text" : "dac~"
								}
...
,
					"patching_rect" : [ 352.5, 80.0, 83.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 320.0, 108.0, 31.0, 20.0 ],
					"text" : "+~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 320.0, 30.0, 31.0, 20.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 320.0, 60.0, 81.0, 20.0 ],
					"saved_object_attributes" : 					{
						"basictuning" : 440,
						"followglobaltempo" : 0,
						"formantcorrection" : 0,
						"mode" : "basic",
						"originallength" : [ 9932.799999999995634, "ticks" ],
...
, 			{
				"box" : 				{
					...
					"numpoints" : 441,
					"outlettype" : [ "" ],
					"patching_rect" : [ 450.0, 40.0, 100.0, 50.0 ],
					"subplots" : [ 						{
							"color" : [ 0.3125, 1.0, 0.838867, 1.0 ],
							"thickness" : 1.200000047683716,
							"point_style" : "none",
...
, 							{
								"box" : 								{
									"code" : "Buffer input(\"input\");\r\nBuffer o1(\"o1\");\r\nBuffer o2(\"o2\");\r\nHistory go(0);\r\nHistory length(44 * 3999);\r\nHistory toggle(1);\r\nlo = 999;\r\nhi = 44 * 3999;\r\namp = slide(abs(in2), 0, lo);\r\nif(in1) {\r\n\ttoggle = !toggle;\r\n\tlength = hi;\r\n\tgo = elapsed;\r\n}\r\nlength = min(max((amp * hi), lo), length);\r\nx = elapsed - go;\r\nfade = max((length - x) / length, 0);\r\nif(toggle) {\r\n\tout1 = mix(in2, 0, fade);\r\n\t//poke(o1, out1, x);\r\n\tout2 = mix(0, in2, fade);\r\n\t//poke(o2, out2, x);\r\n}\r\nelse {\r\n\tout2 = mix(in2, 0, fade);\r\n\t//poke(o2, out2, x);\r\n\tout1 = mix(0, in2, fade);\r\n\t//poke(o1, out1, x);\r\n}\r\n//poke(input, fade, x);\r\nout3 = toggle;",
									"fontface" : 0,
									"fontname" : "<Monospaced>",
									"fontsize" : 10.0,
									"id" : "obj-3",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 430.0, 10.0, 24.0, 24.0 ]
				}
