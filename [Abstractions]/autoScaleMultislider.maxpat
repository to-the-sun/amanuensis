...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 90.0, 160.0, 56.0, 20.0 ],
					"style" : "",
					"text" : "zl change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.0, 130.0, 101.0, 20.0 ],
					"style" : "",
					"text" : "pack setminmax f f"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 193.0, 130.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 151.0, 10.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 245.0, 50.0, 67.0, 20.0 ],
					"style" : "",
					"text" : "-999999999."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 151.0, 50.0, 63.0, 20.0 ],
					"style" : "",
					"text" : "999999999."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 70.0, 50.0, 45.0, 20.0 ],
					"style" : "",
					"text" : "zl iter 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "" ],
					"patching_rect" : [ 59.5, 30.0, 52.0, 20.0 ],
					"style" : "",
					"text" : "t l bang l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 172.0, 100.0, 104.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 172.0, 80.0, 92.0, 20.0 ],
					"style" : "",
					"text" : "peak -999999999."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "float", "int", "int" ],
					"patching_rect" : [ 70.0, 80.0, 100.0, 20.0 ],
					"style" : "",
					"text" : "Trough 999999999."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 117.0, 50.0, 42.0, 20.0 ],
					"style" : "",
					"text" : "zlclear"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 160.5, 44.5, 254.5, 44.5 ],
					"order" : 0,
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 79.5, 124.5, 140.5, 124.5 ],
					"order" : 0,
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 181.5, 124.5, 202.5, 124.5 ],
					"order" : 0,
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 79.5, 74.5, 181.5, 74.5 ],
					"order" : 0,
					"source" : [ "obj-9", 0 ]
				}
