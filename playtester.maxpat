...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 554.0, 47.0, 87.0, 20.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 546.0, 16.0, 205.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 191.0, 7.0, 205.0, 20.0 ],
					"text" : "load \"Restless Virtuoso.maxpat\" playtester 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 418.0, 115.0, 50.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 418.0, 184.5, 87.0, 20.0 ],
					"text" : "s load_instrument"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 418.0, 137.0, 205.0, 20.0 ],
					"text" : "load \"Restless Virtuoso.maxpat\" playtester 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 263.0, 5.0, 130.0, 130.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 204.0, 276.0, 130.0, 130.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 185.0, 35.0, 34.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 126.0, 306.0, 34.0, 20.0 ],
					"text" : "gate~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 185.0, 5.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 126.0, 276.0, 24.0, 24.0 ]
				}
...
, 							{
								"box" : 								{
									"code" : "Buffer beat(\"beat3\");\r\nParam interval(1000);\r\nout1 = !(elapsed % mstosamps(interval));\r\nout1 += noise() * .0009;",
									"fontface" : 0,
									"fontname" : "<Monospaced>",
									"fontsize" : 10.0,
									"id" : "obj-3",
...
,
					"patching_rect" : [ 205.0, 15.0, 31.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 146.0, 286.0, 31.0, 20.0 ],
					"text" : "gen~"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 480.0, 310.0, 130.0, 130.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 239.0, 190.0, 24.0, 24.0 ]
								}
