...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 320.0, 0.0, 151.0, 98.0 ],
					"text" : " phaserLock reset may be redundant at this point. Must reset at conscious so pre-lock shuffling will choose from among all available zeros. Also, Zlclear probably unnecessary as inactive tracks are discluded by the sect outside of this patch"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 220.0, 20.0, 43.0, 20.0 ],
					"text" : "select 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 220.0, 0.0, 75.0, 20.0 ],
					"text" : "r ---conscious?"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 37.0, 220.0, 100.0, 20.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"precision" : 6
					}
,
					"text" : "coll ratings_by_track"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 23.0, 40.0, 93.0, 20.0 ],
					"text" : "t bang bang zlclear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 13.0, 20.0, 41.0, 20.0 ],
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 13.0, 0.0, 78.0, 20.0 ],
					"text" : "r A_phasorLock"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 211.0, 130.0, 81.0, 20.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"precision" : 6
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 211.0, 150.0, 63.0, 20.0 ],
					"text" : "if $i1 then 0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 297.0, 260.0, 74.0, 20.0 ],
					"text" : "print polymean"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 297.0, 230.0, 139.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 297.0, 200.0, 134.0, 20.0 ],
					"text" : "pack f mean score on track i"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 163.0, 70.0, 48.0, 20.0 ],
					"text" : "thispoly~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 132.5, 90.0, 29.5, 20.0 ],
					"text" : "=="
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 111.5, 120.0, 29.5, 20.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 122.0, 20.0, 95.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 122.0, 70.0, 40.0, 20.0 ],
					"text" : "unjoin"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 40.0, 120.0, 61.0, 20.0 ],
					"text" : "t bang clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 37.0, 200.0, 79.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 97.0, 180.0, 33.0, 20.0 ],
					"text" : "zl reg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 40.0, 90.0, 68.0, 20.0 ],
					"text" : "r ---songEnd"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 111.0, 0.0, 30.0, 30.0 ]
				}
