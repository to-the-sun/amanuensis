...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 232.0, 260.0, 65.0, 20.0 ],
					"text" : "s vst_loaded"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 232.0, 240.0, 56.0, 20.0 ],
					"text" : "onebang 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 340.0, 60.0, 62.0, 20.0 ],
					"text" : "loadmess 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 260.0, 140.0, 80.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 260.0, 120.0, 41.0, 20.0 ],
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 260.0, 90.0, 103.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 260.0, 60.0, 75.0, 20.0 ],
					"text" : "peakamp~ 500"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 280.0, 170.0, 150.0, 18.0 ],
					"text" : "Test your VSTs' presets:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 290.0, 220.0, 119.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 290.0, 190.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 370.0, 190.0, 29.5, 20.0 ],
					"text" : "plug"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 14.0, 212.0, 83.0, 121.0 ],
					"text" : " only if there is no saved count will the auto count be used(It's not always accurate and the users manual settings must be preferred)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 360.0, 110.0, 150.0, 52.0 ],
					"text" : "all messages to VSTs come in through this received and are filtered by this abstraction instance (Track, then plug in)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 200.0, 0.0, 274.0, 52.0 ],
					"text" : " preset counting is begun after Amanuensis.json has recalled the previous saved settings and on loadbang in case there are no saved settings yet. Deferlow (necessary?) ensures the VST is loaded before it is queried."
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 40.0, 140.0, 152.0, 144.0 ],
									"text" : "Expression after compression because the compressor is more of an automatic adjustment and expression is manual, so want to have expression have the final say. Limiter is just clean up at the end (since expression is only reduction it will probably do the job of a limiter anyway; wouldn't want to have double reduction with expression after the limiter)"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 259.0, 160.0, 150.0, 29.0 ],
									"text" : "Expression should only be relevant for VSTs"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "signal" ],
													"patching_rect" : [ 60.5, 120.0, 38.0, 20.0 ],
													"text" : "sig~ 1."
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 95.5, 160.0, 56.0, 20.0 ],
													"sig" : 0.0
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "", "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 144.5, 90.0, 50.0, 20.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "signal" ],
													"patching_rect" : [ 60.5, 140.0, 63.0, 20.0 ],
													"text" : "slide~ 99 99"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 340.0, 200.0, 79.0, 20.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 60.5, 70.0, 74.0, 20.0 ],
													"text" : "r #4expression"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 60.5, 90.0, 82.0, 20.0 ],
...
,
									"patching_rect" : [ 187.0, 160.0, 70.0, 20.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"fontsize" : 10.0,
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 187.0, 180.0, 70.0, 20.0 ],
									"text" : "omx.peaklim~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 360.0, 220.0, 40.0, 20.0 ],
									"text" : "split 0"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 381.0, 240.0, 108.0, 20.0 ],
									"text" : "s #4active_tracks"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 360.0, 110.0, 127.0, 20.0 ],
									"text" : "r #4poll_track_activity"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 360.0, 200.0, 111.0, 20.0 ],
									"text" : "if $f1 > 0.0009 then $i2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 360.0, 140.0, 55.0, 20.0 ],
									"text" : "peakamp~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 24.5, 90.0, 128.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 117.0, 50.0, 75.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 117.0, 30.0, 62.0, 20.0 ],
									"text" : "route plays"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 117.0, 10.0, 75.0, 20.0 ],
									"text" : "r #4sound"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 24.5, 110.0, 85.0, 20.0 ],
									"text" : "prepend bypass"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 24.5, 70.0, 128.0, 20.0 ],
									"text" : "specialBuddy"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 24.5, 50.0, 112.0, 20.0 ],
									"text" : "r #4compress_vsti"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "signal", "signal", "list", "list" ],
									"patching_rect" : [ 187.0, 140.0, 64.0, 20.0 ],
									"text" : "omx.comp~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 197.5, 60.0, 34.0, 20.0 ],
									"text" : "!=~ 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 232.5, 60.0, 34.0, 20.0 ],
									"text" : "!=~ 0."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 490.0, 140.0, 125.0, 20.0 ],
									"text" : "print #3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 187.0, 110.0, 29.5, 20.0 ],
									"text" : "/~ 1."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 187.0, 200.0, 106.0, 20.0 ],
									"text" : "send~ #4monitor"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 262.5, 20.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 145.5, 200.0, 45.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 89.333335876464844, 250.0, 85.0, 20.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"parameter_enable" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 89.333335876464844, 230.0, 127.833328247070312, 20.0 ],
					"text" : "pack set s i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 89.333335876464844, 210.0, 30.0, 20.0 ],
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 492.5, 90.0, 158.0, 31.0 ],
					"text" : "print #3\" Counting VST presets…\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 198.0, 190.0, 31.0, 20.0 ],
					"text" : "bang"
				}
...
,
					"text" : "dict vst_presets",
					"varname" : "vst_preset_quantities[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 198.0, 210.0, 61.0, 20.0 ],
					"text" : "counter"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 145.5, 170.0, 92.5, 20.0 ],
