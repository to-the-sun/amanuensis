...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 260.0, 80.0, 150.0, 29.0 ],
					"text" : "---active will come through once ---initialize_stream"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 302.0, 130.0, 90.0, 20.0 ],
					"text" : "r #0instrument"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 231.0, 150.0, 90.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 231.0, 130.0, 56.0, 20.0 ],
					"text" : "r ---active"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 390.0, 370.0, 150.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 120.0, 310.0, 159.0, 62.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 490.0, 240.0, 150.0, 74.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 440.0, 150.0, 159.0, 85.0 ],
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "int" ],
													"patching_rect" : [ 88.666656000000003, 70.0, 46.0, 20.0 ],
													"text" : "t bang i"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 147.833327999999995, 180.0, 29.5, 20.0 ],
													"text" : "&&"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 136.666655999999989, 50.0, 80.0, 20.0 ],
													"text" : "r #0instrument"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 147.833327999999995, 200.0, 30.0, 30.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "", "", "" ],
													"patching_rect" : [ 137.333327999999995, 160.0, 40.0, 20.0 ],
													"text" : "unjoin"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 89.166656000000003, 100.0, 66.5, 20.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 4,
													"outlettype" : [ "dictionary", "", "", "" ],
													"patching_rect" : [ 88.666656000000003, 140.0, 69.0, 20.0 ],
													"saved_object_attributes" : 													{
														"embed" : 0,
														"parameter_enable" : 0,
														"parameter_mappable" : 0
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 88.666656000000003, 120.0, 68.0, 20.0 ],
													"text" : "prepend get"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 88.666656000000003, 40.0, 30.0, 30.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 136.666655999999989, 70.0, 146.0, 20.0 ],
													"text" : "sprintf symout %s==|>active"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 4,
													"outlettype" : [ "dictionary", "", "", "" ],
													"patching_rect" : [ 88.666656000000003, 140.0, 165.0, 20.0 ],
													"saved_object_attributes" : 													{
														"embed" : 0,
														"parameter_enable" : 0,
														"parameter_mappable" : 0
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 136.666655999999989, 70.0, 141.0, 20.0 ],
...
,
									"patching_rect" : [ 95.0, 310.0, 63.0, 20.0 ],
									"saved_object_attributes" : 									{
										"accentcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
										"description" : "",
										"digest" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 126.0, 250.0, 102.0, 20.0 ],
									"text" : "s ---default_sustain"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "int" ],
									"patching_rect" : [ 95.0, 230.0, 50.5, 20.0 ],
									"text" : "t s s s 9"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 115.0, 270.0, 58.0, 20.0 ],
									"text" : "s ---device"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 105.0, 290.0, 93.0, 20.0 ],
									"text" : "s #0instrument"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 130.0, 170.0, 159.0, 51.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 90.0, 330.0, 105.0, 20.0 ],
									"text" : "s ---initialize_stream"
								}
...
,
					"patching_rect" : [ 322.0, 40.0, 84.0, 20.0 ],
					"saved_object_attributes" : 					{
						"accentcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
						"description" : "",
						"digest" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 413.0, 150.0, 31.0, 20.0 ],
					"text" : "!= 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 192.0, 170.0, 66.0, 20.0 ],
					"text" : "peakamp~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 413.0, 130.0, 79.0, 20.0 ],
					"text" : "peakamp~ 100"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 200.5, 124.5, 422.5, 124.5 ],
					"order" : 0,
					"source" : [ "obj-22", 0 ]
				}
