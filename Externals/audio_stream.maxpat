...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 390.0, 370.0, 150.0, 41.0 ],
					"style" : "",
					"text" : "Audio streams are much less annoying if they are not on by default"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 340.0, 330.0, 90.0, 20.0 ],
					"style" : "",
					"text" : "r #0instrument"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 308.0, 410.0, 69.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 308.0, 390.0, 83.0, 20.0 ],
					"style" : "",
					"text" : "pak set s 0"
				}
...
,
					"patching_rect" : [ 340.0, 370.0, 52.0, 20.0 ],
					"saved_object_attributes" : 					{
						"accentcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
						"description" : "",
						"digest" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 340.0, 350.0, 146.0, 20.0 ],
					"style" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 380.0, 360.0, 160.0, 20.0 ],
									"style" : "",
									"text" : "print #0MIDI_from_MIDIguitar"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 60.5, 190.0, 82.0, 20.0 ],
													"style" : "",
													"text" : "s ---UI_velocity"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 50.0, 150.0, 31.0, 20.0 ],
													"style" : "",
													"text" : "gate"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 121.0, 100.0, 90.0, 20.0 ],
													"style" : "",
													"text" : "r #0instrument"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 50.0, 120.0, 90.0, 20.0 ],
													"style" : "",
													"text" : "zl compare"
												}
...
,
									"patching_rect" : [ 190.0, 360.0, 93.0, 20.0 ],
									"saved_object_attributes" : 									{
										"accentcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
										"description" : "",
										"digest" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 340.0, 100.0, 154.0, 144.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 170.0, 330.0, 90.0, 20.0 ],
									"style" : "",
									"text" : "r #0instrument"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 100.0, 360.0, 89.0, 20.0 ],
									"style" : "",
									"text" : "append_channel"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 100.0, 380.0, 90.0, 20.0 ],
									"style" : "",
									"text" : "s ---singing_midi"
								}
...
, 											{
												"box" : 												{
													...
													"style" : "",
													"text" : "\"ad_asio Focusrite USB ASIO input 1==|>active\""
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 89.166656, 100.0, 66.5, 20.0 ],
													"style" : "",
													"text" : "\"ad_asio Focusrite USB ASIO input 1==|>tonal\""
												}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 109.5, 354.5, 199.5, 354.5 ],
									"order" : 0,
									"source" : [ "obj-19", 0 ]
								}
