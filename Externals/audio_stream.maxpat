...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 379.0, 70.0, 37.0, 20.0 ],
					"style" : "",
					"text" : "gate~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "dictionary", "", "", "" ],
					"patching_rect" : [ 313.0, 190.0, 69.0, 20.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 313.0, 170.0, 67.0, 20.0 ],
					"style" : "",
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 220.0, 130.0, 154.0, 20.0 ],
					"style" : "",
					"text" : "sprintf symout %s==|>pitch[0]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 313.0, 150.0, 86.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 380.0, 110.0, 39.0, 20.0 ],
					"style" : "",
					"text" : "round"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 380.0, 130.0, 29.5, 20.0 ],
					"style" : "",
					"text" : "i"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 380.0, 90.0, 58.0, 20.0 ],
					"style" : "",
					"text" : "sigmund~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 180.0, 330.0, 155.0, 20.0 ],
					"style" : "",
					"text" : "tosymbol @separator \" input \""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 180.0, 310.0, 52.0, 20.0 ],
					"style" : "",
					"text" : "zl ecils 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 180.0, 290.0, 168.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 141.5, 110.0, 56.0, 20.0 ],
					"style" : "",
					"text" : "r ---active"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 141.5, 130.0, 71.0, 20.0 ],
					"style" : "",
					"text" : "route source"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 131.0, 150.0, 29.5, 20.0 ],
					"style" : "",
					"text" : "&&"
				}
