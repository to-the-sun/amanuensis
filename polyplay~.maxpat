...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 123.5, 180.0, 60.0, 20.0 ],
									"text" : "fromsymbol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 123.5, 200.0, 112.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 185.166666666666686, 160.0, 44.0, 20.0 ],
									"text" : "r ---note"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 28.5, 260.0, 32.0, 20.0 ],
									"text" : "s flag"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 242.166666666666686, 130.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 242.166666666666686, 160.0, 84.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 50.0, 110.0, 44.0, 20.0 ],
									"text" : "t bang l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 28.5, 240.0, 224.0, 20.0 ],
									"text" : "Pak FLAG instrument: sampler pitch: s velocity: i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 72.0, 130.0, 66.0, 20.0 ],
									"text" : "Prepend set"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 50.0, 160.0, 103.0, 20.0 ],
									"text" : "info~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 90.0, 145.0, 20.0 ],
...
,
					"patching_rect" : [ 460.0, 140.0, 35.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 416.5, 220.0, 55.0, 20.0 ],
					"text" : "tosymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 416.5, 240.0, 74.0, 20.0 ],
					"text" : "print polyplay"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 290.0, 79.0, 20.0 ],
					"text" : "send~ _plug-in"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 266.5, 140.5, 110.0, 20.0 ],
					"text" : "sprintf set %i_plug-in"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 266.5, 120.5, 87.0, 20.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"precision" : 6
					}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 276.0, 282.0, 174.0, 282.0, 174.0, 282.0, 144.5, 282.0 ],
					"order" : 1,
					"source" : [ "obj-13", 0 ]
				}
