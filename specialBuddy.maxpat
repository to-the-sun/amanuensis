...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 238.0, 60.0, 48.0, 20.0 ],
					"style" : "",
					"text" : "t clear 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 238.0, 30.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 121.0, 190.0, 37.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 199.0, 180.0, 37.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 199.0, 200.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 151.0, 160.0, 67.0, 20.0 ],
					"style" : "",
					"text" : "t bang bang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 121.0, 210.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 151.0, 140.0, 58.0, 20.0 ],
					"style" : "",
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 151.0, 110.0, 29.5, 20.0 ],
					"style" : "",
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 151.0, 90.0, 40.0, 20.0 ],
					"style" : "",
					"text" : "buddy"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 190.0, 60.0, 46.0, 20.0 ],
					"style" : "",
					"text" : "t bang l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 112.0, 60.0, 46.0, 20.0 ],
					"style" : "",
					"text" : "t bang l"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 160.5, 184.5, 130.5, 184.5 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 121.5, 134.5, 199.5, 134.5 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 148.5, 84.5, 160.5, 84.5 ],
					"order" : 0,
					"source" : [ "obj-7", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 226.5, 84.5, 226.5, 84.5 ],
					"order" : 0,
					"source" : [ "obj-8", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 1 ],
					"midpoints" : [ 226.5, 84.5, 181.5, 84.5 ],
					"order" : 1,
					"source" : [ "obj-8", 1 ]
				}
