...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 394.5, 40.0, 31.0, 20.0 ],
					"text" : "bang"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 380.0, 60.0, 36.0, 20.0 ],
									"text" : "r pass"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 380.0, 80.0, 37.0, 20.0 ],
									"text" : "v pass"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 80.5, 130.0, 49.0, 20.0 ],
									"text" : "v #0pass"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 169.5, 170.0, 46.0, 20.0 ],
									"text" : "s palette"
								}
...
,
					"patching_rect" : [ 329.5, 270.0, 87.708333333333314, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 480.0, 150.0, 47.0, 20.0 ],
					"text" : "r #0pass"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 480.0, 170.0, 49.0, 20.0 ],
					"text" : "v #0pass"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 405.0, 80.0, 47.0, 20.0 ],
					"text" : "r #0pass"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 220.0, 160.0, 47.0, 20.0 ],
					"text" : "r #0pass"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 230.0, 49.0, 20.0 ],
					"text" : "s #0pass"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 394.5, 60.0, 37.0, 20.0 ],
					"text" : "v pass"
				}
...
,
					"patching_rect" : [ 120.5, 250.0, 55.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 161.5, 130.0, 150.0, 18.0 ],
					"text" : "clear ui 1st"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 177.5, 380.0, 29.5, 20.0 ],
					"text" : "*"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 380.0, 370.0, 55.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 932.0, 10.0, 68.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 126.5, 360.0, 70.0, 20.0 ],
					"text" : "sampstoms~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 89.5, 340.0, 56.0, 20.0 ],
					"sig" : 0.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 89.5, 320.0, 52.0, 20.0 ],
					"text" : "receive~ t"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2.0, 380.0, 87.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 2.0, 410.0, 38.5, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 1000.0, 40.0 ],
					"setminmax" : [ 91655.4375, 92095.8984375 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 330.0, 130.0, 61.0, 20.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 330.0, 100.0, 42.0, 20.0 ],
					"text" : "r others"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 220.0, 210.0, 50.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 177.5, 270.0, 61.0, 20.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 120.5, 230.0, 46.0, 20.0 ],
					"text" : "+ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 87.5, 120.0, 29.5, 20.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 137.5, 200.0, 40.0, 20.0 ],
					"text" : "unjoin"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 137.5, 180.0, 77.0, 20.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"precision" : 6
					}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 4,
					"outlettype" : [ "float", "", "set", "nothing" ],
					"patching_rect" : [ 120.5, 150.0, 91.0, 20.0 ],
					"text" : "t f #1    set nothing"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 120.5, 130.0, 35.0, 20.0 ],
					"text" : "r from"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 120.5, 300.0, 138.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 1000.0, 40.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 339.0, 193.0, 315.0, 193.0, 315.0, 124.0, 339.5, 124.0 ],
					"order" : 1,
					"source" : [ "obj-11", 0 ]
				}
