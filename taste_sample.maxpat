...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 170.0, 420.0, 65.0, 20.0 ],
					"text" : "loadmess #3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 190.0, 127.0, 190.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 396.0, 490.0, 141.0, 20.0 ],
					"text" : "print Document_sample_taste"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 380.0, 152.0, 75.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 71.0, 136.0, 110.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 390.666656494140625, 60.0, 186.0, 41.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 80.0, 130.0, 45.0, 20.0 ],
									"text" : "route #1",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 80.0, 110.0, 39.0, 20.0 ],
									"text" : "zl rot 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 80.0, 90.0, 77.0, 20.0 ],
									"text" : "r #4taste_notes"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 80.0, 150.0, 66.0, 20.0 ],
									"text" : "routepass #2"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 80.0, 180.0, 103.0, 20.0 ],
									"text" : "borax"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 122.0, 240.0, 54.0, 20.0 ],
									"text" : "r A_wake"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 101.0, 200.0, 40.0, 20.0 ],
									"text" : "split 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "int", "int" ],
									"patching_rect" : [ 85.0, 290.0, 45.0, 20.0 ],
									"text" : "change"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 85.0, 260.0, 56.0, 20.0 ],
									"text" : "pipe 8000"
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 131.5, 224.5, 59.5, 224.5 ],
									"source" : [ "obj-20", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 110.5, 253.5, 94.5, 253.5 ],
									"source" : [ "obj-20", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-8", 0 ],
									"midpoints" : [ 77.0, 283.5, 94.5, 283.5 ],
									"source" : [ "obj-23", 1 ]
								}
...
,
					"patching_rect" : [ 130.0, 130.0, 64.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 143.5, 360.0, 97.0, 20.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"parameter_enable" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 143.5, 340.0, 60.0, 20.0 ],
					"text" : "pack get #3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 303.166656494140625, 420.0, 56.833334147930145, 20.0 ],
					"text" : "+ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "dictionary", "", "", "" ],
					"patching_rect" : [ 236.166656494140625, 490.0, 97.0, 20.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 236.166656494140625, 470.0, 67.0, 20.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 236.166656494140625, 450.0, 86.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 244.5, 120.0, 80.0, 20.0 ],
					"text" : "zl 32727 mth #2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 207.833328247070313, 40.0, 143.0, 20.0 ],
					"text" : "route pre-set samples channel"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 207.833328247070313, 20.0, 53.0, 20.0 ],
					"text" : "r #4sound"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 166.5, 334.5, 350.49999064207077, 334.5 ],
					"source" : [ "obj-14", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-13", 1 ],
					"midpoints" : [ 186.166656494140625, 414.5, 350.49999064207077, 414.5 ],
					"source" : [ "obj-17", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 299.999994913736998, 84.5, 222.0, 84.5 ],
					"source" : [ "obj-2", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 222.0, 264.5, 194.0, 264.5 ],
					"order" : 1,
					"source" : [ "obj-24", 0 ]
				}
