...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 135.25, 310.0, 40.0, 20.0 ],
					"text" : "t i 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 166.25, 510.0, 41.0, 20.0 ],
					"text" : "t bang l"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 31.25, 600.0, 55.0, 20.0 ],
					"text" : "s #3sound"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 31.25, 580.0, 80.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 31.25, 560.0, 70.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 31.25, 540.0, 83.0, 20.0 ],
					"text" : "symbol 1:pitches",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 135.25, 280.0, 45.0, 20.0 ],
					"text" : "route #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 135.25, 260.0, 99.0, 20.0 ],
					"text" : "r #3pitch-countdown"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 206.25, 50.0, 50.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 206.25, 70.0, 98.0, 20.0 ],
					"text" : "v #3new_pitch_after"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 245.25, 120.0, 29.5, 20.0 ],
					"text" : "> 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 245.25, 90.0, 96.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 254.0, 160.0, 45.0, 20.0 ],
					"text" : "gate 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 265.5, 300.0, 45.0, 20.0 ],
					"text" : "gate 1 1"
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 180.0, 125.0, 20.0 ],
									"text" : "s #3pitch_countdown "
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 89.0, 120.0, 32.0, 20.0 ],
									"text" : "* 200"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 50.0, 140.0, 58.0, 20.0 ],
									"text" : "metro"
								}
...
,
					"patching_rect" : [ 134.75, 400.0, 92.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 239.5, 340.0, 29.5, 20.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 239.5, 320.0, 45.0, 20.0 ],
					"text" : "gate 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 110.75, 670.0, 77.0, 20.0 ],
					"text" : "s #3sound"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 110.75, 650.0, 80.0, 20.0 ],
					"text" : "prepend pitches"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 280.0, 140.0, 55.0, 20.0 ],
					"text" : "route pitch"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 280.0, 120.0, 75.0, 20.0 ],
					"text" : "r #3sound"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 115.25, 150.0, 75.0, 20.0 ],
					"text" : "zl.compare vsti"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 115.25, 130.0, 57.0, 20.0 ],
					"text" : "route plays"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 115.25, 110.0, 75.0, 20.0 ],
					"text" : "r #3sound"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 246.25, 490.0, 50.0, 20.0 ],
					"text" : "loadbang",
					"textcolor" : [ 0.980392156862745, 0.317647058823529, 0.317647058823529, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 376.25, 450.0, 72.0, 20.0 ],
					"text" : "v scramble_all",
					"textcolor" : [ 0.980392156862745, 0.317647058823529, 0.317647058823529, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 376.25, 430.0, 50.0, 20.0 ],
					"text" : "loadbang",
					"textcolor" : [ 0.980392156862745, 0.317647058823529, 0.317647058823529, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 376.25, 500.0, 45.0, 20.0 ],
					"text" : "Uzi 16 1",
					"textcolor" : [ 0.980392156862745, 0.317647058823529, 0.317647058823529, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 402.25, 520.0, 71.0, 20.0 ],
					"text" : "s #3flush",
					"textcolor" : [ 0.980392156862745, 0.317647058823529, 0.317647058823529, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 376.25, 480.0, 29.5, 20.0 ],
					"text" : "gate",
					"textcolor" : [ 0.980392156862745, 0.317647058823529, 0.317647058823529, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 226.25, 450.0, 110.0, 20.0 ],
					"text" : "t bang bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 348.25, 410.0, 69.0, 20.0 ],
					"text" : "route channel",
					"textcolor" : [ 0.980392156862745, 0.317647058823529, 0.317647058823529, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 348.25, 390.0, 75.0, 20.0 ],
					"text" : "r #3sound",
					"textcolor" : [ 0.980392156862745, 0.317647058823529, 0.317647058823529, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 317.25, 500.0, 71.0, 20.0 ],
					"text" : "s #3flush"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 317.25, 480.0, 50.0, 20.0 ],
					"text" : "1",
					"textcolor" : [ 0.980392156862745, 0.317647058823529, 0.317647058823529, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 499.916666666666629, 520.0, 65.0, 20.0 ],
					"text" : "loadmess #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 396.25, 630.0, 148.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 499.916666666666629, 540.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 499.916666666666629, 580.0, 66.0, 20.0 ],
					"text" : "route symbol"
				}
...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 499.916666666666629, 560.0, 50.5, 20.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"precision" : 6
					}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 396.25, 550.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 396.25, 590.0, 66.0, 20.0 ],
					"text" : "route symbol"
				}
...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 396.25, 570.0, 50.5, 20.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"precision" : 6
					}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 396.25, 650.0, 38.0, 20.0 ],
					"text" : "s OSC"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 396.25, 610.0, 177.0, 20.0 ],
					"text" : "pack s will now be played in place of s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 166.25, 470.0, 29.5, 20.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 226.25, 470.0, 56.0, 20.0 ],
					"text" : "random 12"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 116.25, 560.0, 69.0, 20.0 ],
					"text" : "route channel"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 116.25, 600.0, 129.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 116.25, 620.0, 92.0, 20.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"precision" : 6
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 116.25, 580.0, 109.0, 20.0 ],
					"text" : "sprintf nsub %i:pitches"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 116.25, 540.0, 75.0, 20.0 ],
					"text" : "r #3sound"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 246.25, 510.0, 72.0, 20.0 ],
					"text" : "v scramble_all",
					"textcolor" : [ 0.980392156862745, 0.317647058823529, 0.317647058823529, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 246.25, 560.0, 100.0, 20.0 ],
					"text" : "t bang l",
					"textcolor" : [ 0.980392156862745, 0.317647058823529, 0.317647058823529, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "int" ],
					"patching_rect" : [ 246.25, 580.0, 45.0, 20.0 ],
					"text" : "Uzi 16 1",
					"textcolor" : [ 0.980392156862745, 0.317647058823529, 0.317647058823529, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 246.25, 620.0, 150.0, 20.0 ],
					"text" : "join",
					"textcolor" : [ 0.980392156862745, 0.317647058823529, 0.317647058823529, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 246.25, 640.0, 92.0, 20.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"precision" : 6
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 246.25, 600.0, 109.0, 20.0 ],
					"text" : "sprintf nsub %i:pitches",
					"textcolor" : [ 0.980392156862745, 0.317647058823529, 0.317647058823529, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 246.25, 540.0, 29.5, 20.0 ],
					"text" : "gate",
					"textcolor" : [ 0.980392156862745, 0.317647058823529, 0.317647058823529, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 566.25, 330.0, 99.0, 20.0 ],
					"text" : "print #1note_disuse "
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 566.25, 310.0, 139.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 228.0, 180.0, 45.0, 20.0 ],
					"text" : "gate 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 271.0, 350.0, 65.0, 20.0 ],
					"text" : "loadmess #2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 227.25, 220.0, 35.0, 20.0 ],
					"text" : "sel #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 227.25, 200.0, 31.0, 20.0 ],
					"text" : "% 12"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 226.25, 430.0, 30.0, 20.0 ],
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 226.25, 400.0, 50.0, 20.0 ],
					"text" : "change 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 226.25, 240.0, 29.5, 20.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 291.5, 280.0, 59.0, 20.0 ],
					"text" : "metro 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 135.25, 340.0, 96.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 426.25, 350.0, 50.0, 20.0 ]
				}
...
, 							{
								"box" : 								{
									"code" : "Param countdown(0);\r\nif(in2) {\t\t\t\t\t//0 = off\r\n\tif(in1) {\t\t\t\t//user input\r\n\t\tif(!countdown) {\t//reset\r\n\t\t\tout1 = in2;\r\n\t\t}\r\n\t\telse {\t\t\t\t//double\r\n\t\t\tout1 = min(9999, countdown * 2);\r\n\t\t}\r\n\t}\r\n\telse {\t\t\t\t\t//decrement\r\n\t\tout1 = max(0, countdown - 1);\r\n\t}\r\n}",
									"fontface" : 0,
									"fontname" : "<Monospaced>",
									"fontsize" : 10.0,
									"id" : "obj-3",
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 40.0, 40.0, 470.0, 260.0 ]
								}
...
,
					"patching_rect" : [ 226.25, 370.0, 63.75, 20.0 ],
					"text" : "gen"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 566.25, 290.0, 116.0, 20.0 ],
					"text" : "prepend #1note_disuse "
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 166.25, 490.0, 79.0, 20.0 ],
					"text" : "join @triggers 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 166.25, 450.0, 65.0, 20.0 ],
					"text" : "loadmess #1"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 144.75, 364.5, 235.75, 364.5 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 124.75, 306.99999925494194, 249.0, 306.99999925494194 ],
					"order" : 0,
					"source" : [ "obj-44", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-17", 0 ],
					"midpoints" : [ 235.75, 395.0, 129.75, 395.0, 129.75, 334.5, 144.75, 334.5 ],
					"order" : 3,
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 235.75, 394.5, 144.25, 394.5 ],
					"order" : 2,
					"source" : [ "obj-8", 0 ]
				}
