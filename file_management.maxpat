...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.0, 508.0, 474.0, 22.0 ],
					"text" : "cleanupProjects C:/Users/tothesun/Google Drive/[Tools]/[Max]/Amanuensis/test/ 1 2 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.0, 485.0, 525.0, 22.0 ],
					"text" : "cleanupProjects C:/Users/tothesun/Music/[Works]/[Projects]/[Experiments]/[Projects]/ 1 3 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 28.0, 532.0, 496.0, 22.0 ],
					"text" : "cleanupSongs C:/Users/tothesun/Google Drive/[Tools]/[Max]/Amanuensis/test/ 1 2 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 164.0, 562.0, 575.0, 22.0 ],
					"text" : "run \"C:/Users/tothesun/Desktop/Amanuensis/Video Amanuensis/OSCApp.exe\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 149.0, 598.0, 575.0, 22.0 ],
					"text" : "run \"C:/Users/tothesun/Google Drive/[Tools]/cafw.exe\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 196.0, 364.0, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 222.0, 424.0, 575.0, 22.0 ],
					"text" : "createFolder C:/Users/tothesun/Desktop// XXX"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 196.0, 386.0, 123.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 196.0, 308.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 196.0, 342.0, 90.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 28.0, 532.0, 98.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 676.0, 91.0, 400.0, 220.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 87.0, 444.0, 286.0, 22.0 ],
					"text" : "createFolder ~/Desktop/AUniqueName-13101 folder"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 28.0, 69.0, 125.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 28.0, 564.0, 153.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 171.5, 609.0, 712.0, 609.0, 712.0, 404.0, 685.5, 404.0 ],
					"source" : [ "obj-1", 1 ]
				}
