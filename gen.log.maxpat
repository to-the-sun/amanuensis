...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 80.0, 87.0, 20.0 ],
					"text" : "r assemble_logs"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 141.0, 250.0, 89.0, 20.0 ],
					"text" : "s assemble_logs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 30.0, 270.0, 66.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 250.0, 109.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 30.0, 210.0, 111.0, 20.0 ],
					"text" : "metro 5001 @active 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 314.0, 320.0, 66.0, 20.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 314.0, 300.0, 86.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 280.0, 20.0, 156.0, 41.0 ],
					"text" : "arguments for the abstraction are (#1) length of buffer in samples (#2) buffer name"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 340.0, 100.0, 150.0, 41.0 ],
					"text" : "outputs the contents and clears the buffer every 5 seconds"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 50.0, 99.0, 64.0 ],
					"text" : "Dumps the buffer when full. Currently disabled so as not to overflow anything"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 325.0, 230.0, 72.0, 20.0 ],
					"text" : "sampstoms~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 261.0, 190.0, 42.0, 20.0 ],
					"text" : "split 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 100.0, 66.0, 20.0 ],
					"text" : "speedlim 99"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 100.0, 160.0, 34.0, 20.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 261.0, 150.0, 161.0, 20.0 ],
					"text" : "t i i i"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "@frame", "float" ],
					"patching_rect" : [ 284.0, 210.0, 60.0, 20.0 ],
					"text" : "t @frame f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 403.0, 180.0, 97.0, 20.0 ],
					"text" : "peek~ #2 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 284.0, 300.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 100.0, 80.0, 107.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 284.0, 270.0, 194.0, 20.0 ],
					"text" : "pack @frame f @sample f #2 : f "
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 261.0, 170.0, 98.0, 20.0 ],
					"text" : "peek~ #2 2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 100.0, 130.0, 180.0, 20.0 ],
					"text" : "Uzi #1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 100.0, 40.0, 29.5, 20.0 ],
					"text" : "#1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 100.0, 20.0, 99.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 100.0, 60.0, 98.0, 20.0 ],
					"text" : "peek~ #2 2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 100.0, 180.0, 176.0, 20.0 ],
					"text" : "buffer~ #2 0 3 @samps #1 "
				}
