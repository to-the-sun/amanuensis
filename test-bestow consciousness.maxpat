...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 440.0, 52.0, 113.0, 20.0 ],
					"style" : "",
					"text" : "recordingChannel 1 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 440.0, 200.0, 330.0, 20.0 ],
					"style" : "",
					"text" : "6004 20 63 10 1. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 430.0, 150.0, 153.0, 20.0 ],
					"style" : "",
					"text" : "mxj net.udp.recv @port 10241"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 556.0, 52.0, 50.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 556.0, 80.0, 86.0, 20.0 ],
					"style" : "",
					"text" : "$1 20 63 10 1. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 470.0, 30.0, 137.0, 20.0 ],
					"style" : "",
					"text" : "projectPath \"C:/some file/\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 370.0, 80.0, 39.0, 20.0 ],
					"style" : "",
					"text" : "lock 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 420.0, 80.0, 113.0, 20.0 ],
					"style" : "",
					"text" : "1055100 20 63 10 1. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 420.0, 110.0, 253.0, 20.0 ],
					"style" : "",
					"text" : "mxj net.udp.send @address localhost @port 10240"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 55.0, 40.0, 395.0, 20.0 ],
					"style" : "",
					"text" : "C:/WINDOWS/udp.py"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 260.0, 103.0, 20.0 ],
					"style" : "",
					"text" : "prepend START \\\"\\\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 30.0, 110.0, 49.0, 20.0 ],
					"style" : "",
					"text" : "t bang s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 360.0, 270.0, 330.0, 31.0 ],
					"style" : "",
					"text" : "START \\\"\\\" \"\\\"C:\\\"\\\"Users\\\"\\\"tothesun\\\"\\\"Google Drive\\\"\\\"[Tools]\\\"\\\"[Projects]\\\"\\\"Amanuensis\\\"\\\"udp.py\\\"\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 0.0, 395.0, 20.0 ],
					"style" : "",
					"text" : "\"C:/Users/tothesun/Google Drive/[Tools]/[Projects]/Amanuensis/udp.py\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 60.0, 200.0, 48.0, 20.0 ],
					"style" : "",
					"text" : "zl group"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 170.0, 110.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 220.0, 120.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 130.0, 129.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 340.0, 75.0, 20.0 ],
					"style" : "",
					"text" : "mxj DOShack"
				}
