...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 270.0, 410.0, 150.0, 75.0 ],
					"text" : "Must start out with a default track or transients won't come through. Set to most staccato track so anything that doesn't belong there will be easily outcompeted"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 380.0, 330.0, 60.0, 20.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 330.0, 181.0, 150.0, 29.0 ],
					"text" : "Transients used here just to ensure transitions on-transient"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 68.0, 70.0, 150.0, 29.0 ],
					"text" : "Running averageWould be better"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 333.0, 300.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 212.5, 130.0, 115.0, 20.0 ],
					"text" : "v assessment_interval",
					"varname" : "assessment_interval[1]"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 92.0, 160.0, 65.0, 20.0 ],
					"text" : "mstosamps~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 138.0, 200.0, 80.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 215.0, 250.0, 37.0, 20.0 ],
					"text" : "edge~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 125.0, 300.0, 74.0, 20.0 ],
					"text" : "prepend select"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 215.0, 200.0, 113.0, 20.0 ],
					"text" : "mc.resize~ 1 @select 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 215.0, 160.0, 274.0, 20.0 ],
					"text" : "mc.receive~ jamming_transients 16 @busymapname tracks"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 180.0, 270.0, 54.0, 20.0 ],
					"text" : "stats~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 92.0, 130.0, 114.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 40.0, 40.0, 520.0, 250.0 ]
								}
...
,
					"patching_rect" : [ 215.0, 230.0, 31.0, 20.0 ],
					"text" : "gen~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 270.0, 230.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 203.333333333333314, 320.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.333333333333314, 330.0, 61.0, 20.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 203.333333333333314, 400.0, 69.0, 20.0 ],
					"text" : "send~ audio4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 315.333333333333314, 390.0, 69.0, 20.0 ],
					"text" : "send~ audio4"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 294.333333333333314, 360.0, 40.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "", "bang" ],
					"patching_rect" : [ 203.333333333333314, 300.0, 110.0, 20.0 ],
					"text" : "t bang s bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 234.333333333333314, 320.0, 30.0, 30.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 9.5, 150.0, 29.0 ],
									"text" : "In 1 must be toggle sig~ not click~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 420.0, 20.0, 25.0, 20.0 ],
									"text" : "in 3"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 421.0, 370.0, 31.0, 20.0 ],
									"text" : "out 3"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 250.0, 390.0, 31.0, 20.0 ],
									"text" : "out 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 30.0, 20.0, 25.0, 20.0 ],
									"text" : "in 1"
								}
...
, 							{
								"box" : 								{
									"code" : "require(\"dynamic_crossfade\")\r\nout1, out2, out3 = dynamic_crossfade(in1, in2, in3);",
									"fontface" : 0,
									"fontname" : "<Monospaced>",
									"fontsize" : 10.0,
									"id" : "obj-3",
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 30.0, 50.0, 410.0, 310.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 40.0, 380.0, 31.0, 20.0 ],
									"text" : "out 1"
								}
...
,
					"patching_rect" : [ 203.333333333333314, 360.0, 80.0, 20.0 ],
					"text" : "gen~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 203.333333333333314, 340.0, 27.0, 20.0 ],
					"text" : "sig~"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 134.5, 330.0, 112.166666666666657, 330.0, 112.166666666666657, 189.0, 224.5, 189.0 ],
					"source" : [ "obj-18", 0 ]
				}
